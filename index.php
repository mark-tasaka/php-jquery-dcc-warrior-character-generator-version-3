...
<html>
<head>
<title>Launch Page: Dungeon Crawl Classics Warrior Character Generator Version 3</title>
...
<body>
	...
	<section>
		...
		<h1><img src="images/title.png" alt="Dungeon Crawl Classics Warrior Character Generator Version 3" class="image" /></h1>
        ...
        <p><a href="https://www.oldschooladventures.org/dcc/warrior/"  class="text_link" target="_blank"><span class="bold">Dwarves, Warriors & Mighty Deeds: A DCC Fan Site</span></a></p>

        <p><a href="https://www.tasaka-games.com/dcc/more/classes/warrior/"  class="text_link" target="_blank"><span class="bold">Fantastic Adventures and the Distgruntled Gong Farmer: A DCC Adventure Module</span></a></p>
    ...
    <div class="content9">
        ...
        $("#generate_charactersWarriorV3").click(function(){
         ...
         $("#WarriorFormV3").attr('action', "character3/dccWarrior.php");
